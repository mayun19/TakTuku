...
const Home = () => {
  ...
  const fetchFilter = async (id: number) => {
    ...
    await axios
      ...
      .then((res) => {
        const { data } = res;
        const filter_id = `/[${id}]/g`;
        const searchRegex = new RegExp(filter_id);
      ...
      <div className="container mt-5">
        ...
        <div className="row category mt-5">
          <ul className="navbar-nav d-flex flex-row justify-content-center">
            ...
            <li className="nav-item mx-4">
              <button className="btn" onClick={() => fetchFilter(1)}>
                Women
              </button>
            </li>
            <li className="nav-item mx-4">
              <button className="btn" onClick={() => fetchFilter(2)}>
                Men
              </button>
            </li>
            <li className="nav-item mx-4">
              <button className="btn" onClick={() => fetchFilter(3)}>
                Kids
              </button>
            </li>
          </ul>
